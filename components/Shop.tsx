...
const Shop = ({ categories, brands }: Props) => {
  ...
  // fetchProducts is now properly closed ---
    ...
    <div className="border-t">
      <Container className="mt-5">
        ...
        <div className="flex flex-col md:flex-row gap-5 border-t border-t-shop_dark_green/50">
          {/* Sidebar */}
          <div className="md:sticky md:top-20 md:self-start md:h-[calc(100vh-160px)] md:overflow-y-auto md:min-w-64 pb-5 md:border-r border-r-shop_dark_green/50 sidebar-scroll">
            <CategoryList
